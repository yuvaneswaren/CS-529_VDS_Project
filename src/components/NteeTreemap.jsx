...
//   const maxValue = Math.max(...treeData.children.map((c) => c.value || 0), 0);

//   const colorScale =
//     maxValue > 0
//       ? scaleLinear()
//           .domain([1, maxValue])
//           .range([interpolateBlues(0.3), interpolateBlues(0.95)])
//       : () => colors.primary[500];
...
//         innerPadding={3}
//         outerPadding={3}
//         label={(node) => node.id} // keep letter on the tile itself
//         labelSkipSize={18}
//         labelTextColor={{
//           from: "color",
//           // keep your "brighter" tweak
...
//         }}
//         // ✅ d3-powered color mapping instead of static scheme
...
//           },
//         }}
//         // 🔍 Custom tooltip: show description + formatted count
//         // and flip left/right based on node position (your logic preserved)
//         tooltip={({ node }) => {
